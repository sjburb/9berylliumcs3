...
## Test Run
![Relationship Test Run](Images%20Folder/relationshipTestRun.png)
## Object Relationship Diagram
![Object Relationship Diagram](Images%20Folder/objectRelationshipDiagram.png)
## Analysis
...
### Why did you store an object reference instead of copying its data? So that the Console can access the game's actual attributes and methods.
